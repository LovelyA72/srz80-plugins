...
public:
	...
	public:
		...
		virtual bool get_e_flag() const = 0;
	};
	...
	// Return the nominal W65C816 clock count. Conditional branches and
	// indexed accesses use their non-extra-cycle count because the disassembler
	// has no execution result or bus timing context.
	u32 instruction_cycles(offs_t pc, const data_buffer &opcodes) const;

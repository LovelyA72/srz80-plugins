...
/* Embedders which own memory outside rv32emu can force every data access
 * through riscv_io_t even in bare-metal (non-SYSTEM) mode. */
#ifndef RV32_FEATURE_HOST_IO
#define RV32_FEATURE_HOST_IO 0
#endif
...
#endif
/* ZLIB */
#ifndef RV32_FEATURE_LINK_ZLIB
#define RV32_FEATURE_LINK_ZLIB 0
#endif

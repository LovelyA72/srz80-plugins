...
scratch_root="${SRZ80_SCRATCH_DIR:-$script_dir/../../scratch/riscv-vrc6}"
...
"$gcc" -march=rv32i -mabi=ilp32 -msmall-data-limit=0 -nostdlib -nostartfiles -Os -ffreestanding \
    ...
    -o "$temp_dir/vrc6.elf" "$script_dir/vrc6.c"
"$objcopy" -O binary "$temp_dir/vrc6.elf" "$script_dir/vrc6.rom"
